...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:40px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><h1 style="text-align: center"><span style="font-size: 36px; font-family: &quot;times new roman&quot;, times, serif; color: #737373">📸 Validation &nbsp;Commande n# ${
          order.id
        }📸</span></h1><div></div></div></td>
      </tr>
    </tbody>
  </table><table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="f71635df-9742-46a2-ae0d-bd6555abaea5.1">
    <tbody>
      <tr>
        <td height="100%" valign="top" role="module-content"><h3 style="text-align: center; display:flex; justify-content:center;">
    <span style="font-family: times new roman,times,serif">C'est validé ? click sur <a href="${link}">ce lien</a> et on se charge du reste !</span>
</h3></td>
      </tr>
    </tbody>
...
${addPrints(formats)}<div></div></div></td>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:30px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><h2 style="text-align: inherit">💸 Prix Total:&nbsp;${getTotalPrice(
          formats,
        )} €</h2><div></div></div></td>
      </tr>
    </tbody>
  ...
  </table><table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="f71635df-9742-46a2-ae0d-bd6555abaea5.1.1">
    <tbody>
      <tr>
        <td height="100%" valign="top" role="module-content"><h3 style="text-align: center; display:flex; justify-content:center;">
    <span style="font-family: times new roman,times,serif">C'est validé ? click sur <a href="${link}">ce lien</a> et on se charge du reste !</span>
    ...
    (
      ...
      <ul>
        ...
        <li style="text-align: inherit; font-family: &quot;times new roman&quot;, times, serif; font-size: 18px; font-size: 18px"><span style="font-family: &quot;times new roman&quot;, times, serif; font-size: 18px">format: <b>${
          format.with_frame ? format.size_frame + ' (avec cadre)' : format.size
        }</b></span></li>
      </ul>
    </li>
    </ul>`,
